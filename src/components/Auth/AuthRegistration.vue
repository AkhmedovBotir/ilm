      ...
      <div class="forms w-100">
        <div class="auth_form__inputs">
          ...
          <div>
            ...
            <v-text-field class="input" filled prefix="+998" v-model.trim="user.phone" name="phone" type="number" :label="$t('form.phone_number')" :rules="[rules.required, rules.minLength(9)]" ></v-text-field>
          </div>
          ...
          <v-text-field class="input" id="password" v-model.trim="user.password" :rules="passwordRULES"
            ...
            :error="isConfirmPasswordError" :error-txt="confirmPasswordErrorText" :rules="[...passwordRULES]" is-password :type="'password'"
    ...
    return {
      ...
      rules: {
        ...
        minLength: (length) => (value) =>
          (value && value.length >= length) || this.$t('mix.maydon_hajm'),
      ...
      (value) => !!value || this.$t('mix.maydon_bosh'),
        (value) =>
          (value && value.length >= 6) || this.$t('mix.maydon_hajm'),
    ]
    };
  },
  computed: {
